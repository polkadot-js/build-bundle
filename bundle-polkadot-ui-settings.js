(function (global, factory) {
    ...
    class Settings {
        constructor() {
            ...
            __classPrivateFieldSet(this, _Settings_prefix, util$7.isUndefined(settings.prefix) ? PREFIX_DEFAULT : settings.prefix, "f");
        ...
        set(settings) {
            ...
            __classPrivateFieldSet(this, _Settings_prefix, util$7.isUndefined(settings.prefix) ? __classPrivateFieldGet(this, _Settings_prefix, "f") : settings.prefix, "f");
