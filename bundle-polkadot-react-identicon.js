(function (global, factory) {
	...
	const StyledImg = styled$1.img(({ size }) => `
  display: block;
  height: ${size}px;
  width: ${size}px;
`);
	...
	class BaseIcon extends r$1.PureComponent {
	    ...
	    render() {
	        ...
	        return !address
	            ? wrapped
	            : (jsxRuntimeExports.jsx(lib, { onCopy: this.onCopy, text: address, children: wrapped }));
	    }
