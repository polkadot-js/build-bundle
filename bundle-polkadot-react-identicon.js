(function (global, factory) {
...
})(this, (function (exports, r, uiSettings, util, utilCrypto) { 'use strict';
	...
	const Beachball = r.memo(Identicon$5);
	...
	const Empty = r.memo(Identicon$4);
...
`);
	...
	function Identicon$2({ className = '', publicKey, size, style }) {
	    const html = r.useMemo(() => ({ __html: toSvg(publicKey.substring(2), size) }), [publicKey, size]);
	    return (jsxRuntimeExports.jsx("div", { className: className, dangerouslySetInnerHTML: html, style: style }));
	}
	const Jdenticon = r.memo(Identicon$2);
	...
	function Identicon$1({ address, className = '', isAlternative = false, size, style }) {
	    const circles = r.useMemo(() => polkadotIcon(address, { isAlternative }), [address, isAlternative]);
	...
	const Polkadot = r.memo(Identicon$1);
	...
	var _react = _interopRequireDefault(r);
