(function (global, factory) {
	...
	function requirePackageInfo () {
		...
		packageInfo$1.packageInfo = { name: '@polkadot/hw-ledger-transports', path: typeof __dirname === 'string' ? __dirname : 'auto', type: 'cjs', version: '11.0.1' };
	...
	(function (exports) {
		...
		var packageInfo_1 = requirePackageInfo();
	...
	class Ledger {
	    ...
	    async getApp() {
	        if (!this.#app) {
	            const def = browser.transports.find(({ type }) => type === this.#transport);
	            if (!def) {
